...
public class FertilizerSolution extends AbstractTimedSolution {
	...
	protected void part2() {
		AlmanacSeedRanges almanac = new AlmanacParser().parseInputToSeedRanges(input);
		long lowestLocation = new LocationLocator().findLowestLocationWithRanges(almanac);
		System.out.println("The lowest location number that corresponds to any of the initial seed numbers (ranges): " + lowestLocation);
	}
