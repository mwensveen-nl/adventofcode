...
public class CorruptionChecksumSolution {
    private static final String INPUT = "6046    6349    208 276 4643    1085    1539    4986    7006    5374    252 4751    226 6757    7495    2923\n" +
    ...
    public static void main(String[] args) {
        ...
        System.out.println("part one: " + corruptionChecksum.calculate());

        CorruptionChecksumEvenlyDivisibleValues corruptionChecksumEvenlyDivisibleValues = new CorruptionChecksumEvenlyDivisibleValues(INPUT);
        System.out.println("part two: " + corruptionChecksumEvenlyDivisibleValues.calculate());
    }
}
