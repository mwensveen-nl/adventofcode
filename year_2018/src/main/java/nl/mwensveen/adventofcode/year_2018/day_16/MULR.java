...
public class MULR implements OpCode {
    ...
    public List<Integer> perform(List<Integer> registersIn, List<Integer> instruction) {
        ...
        registersOut.set(getTargetRegister(instruction), getFromRegister(registersIn, instruction, A) * getFromRegister(registersIn, instruction, B));
        return registersOut;
