...
public class MULI implements OpCode {
    ...
    public List<Integer> perform(List<Integer> registersIn, List<Integer> instruction) {
        ...
        registersOut.set(getTargetRegister(instruction), getFromRegister(registersIn, instruction, A) * getImmediate(instruction, B));
        return registersOut;
