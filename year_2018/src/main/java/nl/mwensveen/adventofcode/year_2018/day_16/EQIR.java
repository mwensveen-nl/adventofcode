...
public class EQIR implements OpCode {
    ...
    public List<Integer> perform(List<Integer> registersIn, List<Integer> instruction) {
        ...
        registersOut.set(getTargetRegister(instruction), getImmediate(instruction, A).equals(getFromRegister(registersIn, instruction, B)) ? 1 : 0);
        return registersOut;
    }
