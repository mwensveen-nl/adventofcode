...
public class GTRI implements OpCode {
    ...
    public List<Integer> perform(List<Integer> registersIn, List<Integer> instruction) {
        ...
        registersOut.set(getTargetRegister(instruction), getFromRegister(registersIn, instruction, A).intValue() > getImmediate(instruction, B) ? 1 : 0);
        return registersOut;
